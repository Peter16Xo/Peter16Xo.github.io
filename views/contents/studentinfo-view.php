...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-settings zmdi-hc-fw"></i> Datos del profesor</h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de actualización de los datos de los profesores. Acá podrá actualizar la información personal de los profesores registrados en el sistema.
	</p>
</div>
<?php 
	require_once "./controllers/teacherController.php";

	$teacherIns = new teacherController();

	if(isset($_POST['code'])){
		echo $teacherIns->update_teacher_controller();
	}

	$code=explode("/", $_GET['views']);

	$data=$teacherIns->data_teacher_controller("Only",$code[1]);
	if($data->rowCount()>0):
		$rows=$data->fetch();
?>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>teacherlist/" class="btn btn-info btn-raised btn-sm">

...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-face zmdi-hc-fw"></i> Usuarios <small>(Profesores)</small></h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de profesores, aquí podrás registrar nuevos profesores (Los campos marcados con * son obligatorios para registrar un profesor).
	</p>
</div>
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
	  	<li class="active">
	  	<a href="<?php echo SERVERURL; ?>teacher/" class="btn btn-info">
	  		<i class="zmdi zmdi-plus"></i> Nuevo
	  	</a>
	  	</li>
	  	<li>
	  		<a href="<?php echo SERVERURL; ?>teacherlist/" class="btn btn-success">
...
<?php 
	...
	if(isset($_POST['name']) && isset($_POST['username'])){
		echo $insTeacher->add_teacher_controller();
	}
?>
<div class="container-fluid">
	<div class="row">
